        ...
        <body>
            <div class="d-flex" id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form action="FuncionarioServlet?action=gravarAtendimento&id=${atd.id}" method="post">
                        <div class="form-group">
                        <textarea class="form-control" id="textAreaExample2" rows="10"  maxlength="2000" name="solucaoAtendimento" placeholder="Descreva a solução adotada para o caso."></textarea>
                        </div>
                        <br>

        ...
        <body>
            <div class="d-flex" id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <form action="${pageContext.request.contextPath}/UsuarioServlet?action=colaborador" method="post">

                        <select class="custom-select" name="tipoCadastro" id="categoria">
                            <option value="" selected disabled>Selecione o Tipo de Colaborador</option>
                        ...
                        <div class="form-label">
                            <label for="InputPassword1">Confirme a Senha</label>
                        ...
                        <a href="GerenteServlet" class="btn btn-primary" role="button">Voltar</a>                      
                    </form>
                </div>
            </div>
        </div>
